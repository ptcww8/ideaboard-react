...
Category.delete_all
Product.delete_all
cat = Category.find_or_create_by(name: "black top", image_url: "https://colorlib.com/preview/theme/fashi/img/banner-1.jpg")
...
cat = Category.find_or_create_by(name: "high heel shoes", image_url: "https://colorlib.com/preview/theme/fashi/img/banner-2.jpg")
...
cat = Category.find_or_create_by(name: "shirts and blouse", image_url: "https://colorlib.com/preview/theme/fashi/img/banner-3.jpg")
